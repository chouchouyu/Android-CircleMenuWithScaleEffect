...
public class CircleLayout extends ViewGroup {
    ...
    private void setChildAngles() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            childWidth = selfDesinWidth;
            childHeight = selfDesinWidth;
            ...
            if (getChildAt(i).getTag() != null) {
                ...
                if (degree >= 90 && degree < 210) {
                    ...
                    childWidth = (int) ((MIDScale - ((MIDScale - MINScale) / angleDelay * (degree - 210))) * selfDesinWidth);
                    childHeight = (int) ((MIDScale - ((MIDScale - MINScale) / angleDelay * (degree - 210))) * selfDesinWidth);
                } else {
                    if (degree < 90) {
                        degree += 360;
  }
    ...
    private void animateTo(float endDegree, final long duration) {
